...
export const ComnCodMgrModal: FC<IComnCodMgrModalProps> = ({
    onPostSuccess,
    grpCod,
    setGrpCod,
}) => {
    ...
    const searchDetail = async (grpCod: string) => {
        ...
        try {
            await axios(postAction).then(
                (res: AxiosResponse<IDetailResponse>) => {
