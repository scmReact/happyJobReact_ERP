...
export const ComnCodeMgrDetailModal: FC<IComnCodeMgrDetailModalProps> = ({
    detailCod,
    onPostSuccess,
}) => {
    ...
    const searchDetail = () => {
        ...
        axios(postAction).then(
            (res: AxiosResponse<ISelectComnDtlCodResponse>) => {
        ...
        >
            <div className="wrap">
                ...
                <div className="btn-group">
                    <Button onClick={detailCod ? handlerUpdate : handlerSave}>
                        {detailCod ? "수정" : "저장"}
                    </Button>
                    {detailCod ? (
